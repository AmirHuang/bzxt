...
class exploSample(models.Model):
    ...
    picUrl = models.ImageField(max_length=100, upload_to="image/exploSample/", null=True, blank=True,
                               verbose_name="炸药外观图片路径")
...
class exploSampleFile(models.Model):
    ...
    exploSample = models.ForeignKey(exploSample, verbose_name=u"对应的炸药样本", related_name="exploSampleFile",
...
class exploSamplePeak(models.Model):
    ...
    炸药及原材料常见样本峰值表
    """
    exploSampleFile = models.ForeignKey(exploSampleFile, verbose_name=u"对应的炸药文件", related_name="exploSamplePeak",
                                        on_delete=models.CASCADE)
...
class devCompSample(models.Model):
    ...
    sampleAnalyse = models.CharField(max_length=30, null=True, blank=True, verbose_name="样本分析方法")
    analyseCondition = models.CharField(max_length=30, null=True, blank=True, verbose_name="分析条件")
    picUrl = models.ImageField(max_length=100, upload_to="image/devCompSample/", null=True, blank=True,
                               verbose_name="爆炸装置样本外观图片路径")
    picDescrip = models.CharField(max_length=100, null=True, blank=True, verbose_name="图片描述")
    note = models.CharField(max_length=200, null=True, blank=True, verbose_name="备注")
...
class devCompSampleFile(models.Model):
    ...
    devCompSample = models.ForeignKey(devCompSample, verbose_name=u"对应的样本", related_name="devCompSampleFile",
                                      on_delete=models.CASCADE)
    user = models.ForeignKey(UserProfile, verbose_name=u"处理人员", on_delete=models.CASCADE)
    detectDevice = models.CharField(max_length=30, null=True, blank=True, verbose_name="检测设备名称及型号")
    detectMrfs = models.CharField(max_length=20, null=True, blank=True, verbose_name="仪器厂家")
...
class devCompChSample(models.Model):
    ...
    爆炸装置常见样本成分子元素表
    """
    devCompSampleFile = models.ForeignKey(devCompSampleFile, verbose_name=u"对应的物证文件", related_name="devCompChSample",
                                          on_delete=models.CASCADE)
    detectType = models.CharField(max_length=20, null=True, blank=True, verbose_name='检测类型')
    elementsList = models.CharField(max_length=300, null=True, blank=True, verbose_name='元素列表')
...
class devCompSamplePeak(models.Model):
    ...
    爆炸装置常见样本成分峰值表
    """
    devCompSampleFile = models.ForeignKey(devCompSampleFile, verbose_name=u"对应的物证文件", related_name="devCompSamplePeak",
                                          on_delete=models.CASCADE)
    peakPos = models.FloatField(default=0, verbose_name="峰高位置")
    peakHeight = models.FloatField(default=0, verbose_name="峰高")
    peakArea = models.FloatField(default=0, verbose_name="峰面积")
...
class devShapeSample(models.Model):
    ...
    blackWhiteUrl = models.ImageField(max_length=100, null=True, blank=True,
                                      verbose_name="黑白图像路径")  # upload_to="image/devShapeSample/blackWhite/",
    interColorUrl = models.ImageField(max_length=100, null=True, blank=True,
                                      verbose_name="中间彩色图像路径")  # ,upload_to="image/devShapeSample/interColor/"
    middleResultUrl = models.FileField(max_length=100, null=True, blank=True,
                                       verbose_name="第一次文件路径")  # ,upload_to="file/devShapeSample/middleResult"
    ...
    featureUrl = models.FileField(max_length=100, null=True, blank=True,
                                  verbose_name="特征文件路径")  # , upload_to="file/devShapeSample/feature"
    resultPicUrl = models.ImageField(max_length=100, null=True, blank=True,
                                     verbose_name="结果图像形式路径")  # upload_to="image/devShapeSample/result/",
    resultFileUrl = models.FileField(max_length=100, null=True, blank=True,
                                     verbose_name="结果文件形式路径")  # upload_to="file/devShapeSample/result/",
    originalUrl = models.ImageField(max_length=100, upload_to="image/devShapeSample/original/", null=True, blank=True,
                                    verbose_name="原始图像文件路径")  #
    originalResolution = models.CharField(max_length=30, null=True, blank=True, verbose_name="原始图像采集分辨率")
    nomUrl = models.ImageField(max_length=100, upload_to="image/devShapeSample/nom/", null=True, blank=True,
