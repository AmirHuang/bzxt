    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strength', models.CharField(default='', max_length=20, verbose_name='浓度')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detectType', models.IntegerField(choices=[(1, 'FTIF'), (2, 'Raman'), (3, 'XRD'), (4, 'XRF'), (5, 'GC-MS')], verbose_name='检测数据类型')),
                ('docType', models.IntegerField(blank=True, choices=[(1, 'txt'), (2, 'excel'), (3, 'PDF')], null=True, verbose_name='录入文档格式')),
                ('docUrl', models.FileField(blank=True, null=True, upload_to=samples.models.exploSampleFile.get_file_path, verbose_name='录入文档路径')),
                ('strength', models.CharField(default='', max_length=20, verbose_name='浓度')),
                ('handledUrl', models.FileField(blank=True, null=True, upload_to='', verbose_name='处理完的文件')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('url', models.ImageField(blank=True, null=True, upload_to='image/test/', verbose_name='图片测试url')),
            ],
            options={
                'verbose_name': '图片测试',
